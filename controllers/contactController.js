...
//   const additionalEmail = req.query.additionalEmail;
...
//         contactModel.getSecondaryContacts(primaryContactId, row.id)
...
//                 emails: [row.email, additionalEmail].filter(Boolean),
